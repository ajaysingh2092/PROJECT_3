<%@page import="in.co.rays.project_3.ctl.ChangePasswordCtl"%>
	...
	<div>
		...
		<form action="<%=ORSView.CHANGE_PASSWORD_CTL%>" method="post">
			...
			<div class="row log1">
				...
				<input type="hidden" name="createdBy" value="<%=dto.getCreatedBy()%>"> <input type="hidden"
									name="modifiedBy" value="<%=dto.getModifiedBy()%>"> 
 		...
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>Old Password</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i class="fa fa-key"></i></span>
									</div>
<input type="password" name="oldpassword" placeholder="Enter password" style=" border: 2px solid #8080803b;"
                ...
                <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("oldpassword", request)%></font>	
								</div>
								</div>
							</div>
							</div>
				...
				</br><label class="fa fa-key prefix  fa-5x grey-text css"  style="font-size: 1rem;"></label> 
				<input type="password" name="oldpassword" placeholder="Enter password" style=" border: 2px solid #8080803b;"
				id="defaultForm-pass"  	value=<%=DataUtility.getString(request.getParameter("oldpassword") == null ? ""
							: DataUtility.getString(request.getParameter("oldpassword")))%>>
                <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("oldpassword", request)%></font></br> --%>
                                ...
                                <div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>New Password</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i class="fa fa-lock"></i></span>
									</div>
<input	type="password" name="newpassword" placeholder="Enter password" style=" border: 2px solid #8080803b;"
                ...
                <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("newpassword", request)%></font>	
								</div>
								</div>
							</div>
							</div>
                ...
                <label class="fa fa-lock prefix grey-text fa-5x css" style="font-size: 1rem;"></label> 
                <input	type="password" name="newpassword" placeholder="Enter password" style=" border: 2px solid #8080803b;"
				id="defaultForm-pass" 	value=<%=DataUtility.getString(request.getParameter("newpassword") == null ? ""
				: DataUtility.getString(request.getParameter("newpassword")))%>>
...
<input	type="password" name="confirmpassword" placeholder="Enter password" style=" border: 2px solid #8080803b;"
				...
				<input type="submit" name="operation"
								class="btn btn-success btn-md" style="font-size: 17px" value="<%=ChangePasswordCtl.OP_SAVE%>">
