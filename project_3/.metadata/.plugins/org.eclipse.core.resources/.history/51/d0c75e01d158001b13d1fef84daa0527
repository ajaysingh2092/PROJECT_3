<%@page import="in.co.rays.project_3.ctl.CollegeCtl"%>
...
<input type="text" name="name"	id="defaultForm-email" style="border: 2px solid #8080803b;"
		...
		<label	class="fas fa-university prefix grey-text css"	style="font-size: 1rem;"></label> 
		<input type="text" name="name"	id="defaultForm-email" style="border: 2px solid #8080803b;"
									placeholder="Enter Name"
									value="<%=DataUtility.getStringData(dto.getName())%>">
		...
		<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>Address</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i class="fas fa-address-book"></i></span>
									</div>
<input type="text" name="address"	id="defaultForm-email" style="border: 2px solid #8080803b;"
	placeholder="Enter Address"	value="<%=DataUtility.getStringData(dto.getAddress())%>">
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("address", request)%></font>	
		...
		<label class="fas fa-address-book prefix grey-text css"
	...
	<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>state</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i class="fas fa-address-card"></i></span>
									</div>
<input	type="text" name="state" id="defaultForm-email"
	...
	<%-- <span class="pl-sm-5"><b>State</b><span	style="color: red;">*</span></span> </br> 
	<label	class="fas fa-address-card prefix grey-text"></label>
	 <input	type="text" name="state" id="defaultForm-email"
			style="border: 2px solid #8080803b;" placeholder="Enter State"
			value="<%=DataUtility.getStringData(dto.getState())%>">
	...
	<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>City</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i class="far fa-address-card"></i></span>
									</div>
<input type="text" name="city"	id="defaultForm-email" style="border: 2px solid #8080803b;"
	placeholder="Enter City" value="<%=DataUtility.getStringData(dto.getCity())%>">
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("city", request)%></font>	
								</div>
								</div>
							</div>
							</div>
	<%-- <span class="pl-sm-5"><b>City</b><span style="color: red;">*</span></span> </br> 
	<label class="far fa-address-card prefix grey-text css"	style="font-size: 1rem;"></label> 
	<input type="text" name="city"	id="defaultForm-email" style="border: 2px solid #8080803b;"
	placeholder="Enter City" value="<%=DataUtility.getStringData(dto.getCity())%>">
...
<input type="text"	name="mobileNo" placeholder="Enter MobileNo" maxlength="10"
	...
	value="<%=CollegeCtl.OP_UPDATE%>"> <input type="submit"	name="operation" class="btn btn-success btn-md"
