...
<input type="text"	name="firstName" id="defaultForm-email " style="border: 2px solid #8080803b;"
	...
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("firstName", request)%></font><br>
								</div>
								</div>
								</div>
							</div>
...
<input type="text"
	...
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("lastName", request)%></font><br>
								</div>
								</div>
								</div>
							</div>							
...
<input type="password"
	...
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("password", request)%></font><br>
								</div>
								</div>
								</div>
							</div>
...
<input type="text"
								...
								<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("emailId", request)%></font></br>
								</div>
								</div>
								</div>
							</div>
...
<input type="text" 
	...
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("mobileNo", request)%></font></br>
								</div>
								</div>
								</div>
							</div>
...
<%=HTMLUtility.getList("role", String.valueOf(dto.getRoleId()), list)%>
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("role", request)%></font></br>
								</div>
								</div>
								</div>
							</div>
				...
				<div class="col-sm-8">
						<div class="input-group mb-3" >
							...
							<span class="input-group-text" id="basic-addon1"><i class="fa fa-venus-mars"></i></span>
										...
										%>
										<%=htmlList%>
	<font color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("gender", request)%></font></br>
								</div>
								</div>
								</div>
							</div>
...
<input type="text" name="dob" placeholder="Enter Date of Birth" readonly="readonly" 
									onkeydown="return false" style="border: 2px solid #8080803b;"
									id="datepicker"
									value="<%=DataUtility.getDateString(dto.getDob())%>"> <font
									color="red" class="pl-sm-2"> <%=ServletUtility.getErrorMessage("dob", request)%></font></br>
								</div>
								</div>
								</div>
							</div>
