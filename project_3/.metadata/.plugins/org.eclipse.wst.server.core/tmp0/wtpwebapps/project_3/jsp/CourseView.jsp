...
<%@page import="in.co.rays.project_3.ctl.CourseCtl"%>
...
<input type="text"
			...
			<%-- <div class="md-form">
			  <span class="pl-sm-5"><b>Course Name</b><span style="color:red;">*</span></span>
		</br><label class="fa fa-book prefix grey-text css" style="font-size: 1rem;"></label> <input type="text"
									name="courseName" id="defaultForm-email"
									placeholder="Enter Course Name"
									style="border: 2px solid #8080803b;"
									value="<%=DataUtility.getStringData(dto.getCourseName())%>">
							...
							<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" for="exampleInputEmail1"><b>Duration</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3" >
							<div class="input-group-prepend" >
...
<textarea name="description" placeholder="Enter description"
									style="border: 2px solid #8080803b;" rows="3" cols="22"><%=DataUtility.getStringData(dto.getDescription())%></textarea>
								...
								</br> <label class="fa fa-sort-amount-desc prefix grey-text css" style="font-size: 1rem;padding-bottom: 20px; "></label>
								<textarea name="description" placeholder="Enter description"
									style="border: 2px solid #8080803b;" rows="3" cols="27"><%=DataUtility.getStringData(dto.getDescription())%></textarea>
