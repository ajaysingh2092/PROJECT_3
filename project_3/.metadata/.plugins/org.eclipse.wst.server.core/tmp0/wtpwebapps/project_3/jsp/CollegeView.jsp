...
<body class="hm-gradient">
	...
	<div class="container-fluid">
		...
		<form action="<%=ORSView.COLLEGE_CTL%>" method="post">
 		...
 		<div class="row">
 			<label class="control-label col-sm-4" ><b>Name</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
...
<input type="text" name="name"	id="defaultForm-email" style="border: 2px solid #8080803b;"
		...
		<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" ><b>Address</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
...
<input type="text" name="address"	id="defaultForm-email" style="border: 2px solid #8080803b;"
	...
	<div class="form-group">
 		<div class="row">
 			<label class="control-label col-sm-4" ><b>state</b><span style="color: red;">*</span></label>
				<div class="col-sm-8">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
