...
public class SubjectModelJDBCImp implements SubjectModelInt {
	...
	public long add(SubjectDTO dto) throws ApplicationException, DuplicateRecordException {
		long pk = 0;
		  ...
		  System.out.println("subject duplicate    "+duplicataSub); // Check if create Subject already exist 
	...
	public void delete(SubjectDTO dto) throws ApplicationException {
		...
		try{
			con=JDBCDataSource.getConnection();
			con.setAutoCommit(false);
			PreparedStatement pstmt=con.prepareStatement("delete from st_subject where id=?");
	...
	public SubjectDTO findByPk(long pk) throws ApplicationException {
		...
		log.debug("subjectmodel findBy pk end");
