...
//			addTest();
		...
		public static void searchTest() throws ApplicationException {
			...
			dto1.setId(1L);
			dto1.setFirstName("ajay");
			// dto1.setLastName("singh");
		...
		public static void addTest() throws Exception {
			...
			dto.setQualification("be");
			dto.setEmailId("hmm@gmail.com");
			dto.setMobileNo("9898788772");
			dto.setCollegeId((long) 1);
			dto.setCollegeName("svce");
			dto.setCourseId((long) 1);
			dto.setCourseName("pcm");
			dto.setSubjectId((long) 1);
			dto.setSubjectName("maths");
			model.add(dto);
		}
