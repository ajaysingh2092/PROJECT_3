...
<%@page import="in.co.rays.project_3.ctl.ForgetPasswordCtl"%>
...
<br><br>
			<div class="container" align="center" class="row log1">
				<!-- Grid column -->
...
<input	type="text" name="login" id="defaultForm-email" style="border: 2px solid #8080803b;"
									placeholder="Enter emailId" > <font
									color="red" class="pl-sm-5"><%=ServletUtility.getErrorMessage("login", request)%></font>
								</div>
								</div>
								</div>
							</div>
							...
							<%-- <div class="md-form">
							<span  class="pl-sm-2"><b>Email Id</b><span style="color:red;">*</span></span>
								</br><label class="far fa-envelope prefix fa-5x grey-text css" style="font-size: 1rem;"></label> <input
